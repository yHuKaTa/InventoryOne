    ...
    private void getItems() {
        if (Objects.isNull(inventory.getItems()) || inventory.getItems().isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (searchedItem.getId() == choice) {
                    System.out.println("To add new item insert 1");
                    System.out.println("To remove item insert 2");
                    System.out.println("To change item's quantity insert 3");
                    System.out.println("To change item's price insert 4");
                    System.out.println("To change item's name insert 5");
